<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/Member.Master" AutoEventWireup="true" CodeBehind="Change_Password.aspx.cs" Inherits="CncAgro.AccessMember.Change_Password" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:ChangePassword ID="ChangePassword" runat="server" ChangePasswordFailureText="Password incorrect or New Password invalid." OnChangedPassword="ChangePassword1_ChangedPassword" Width="100%">
        <ChangePasswordTemplate>
            <div class="col-md-6 col-sm-12 card card-body">
