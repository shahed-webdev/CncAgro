...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="card card-body">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#Pending" role="tab" aria-controls="Pending" aria-selected="true">Pending Withdraw</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#Confirm" role="tab" aria-controls="profile" aria-selected="false">Completed Withdraw</a>
            </li>
        </ul>
