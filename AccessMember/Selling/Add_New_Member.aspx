...
SELECT @ShoppingID = Scope_identity()"
    ...
    <script>
        $("#add-customer").addClass('L_Active');
        ...
        const addMember = (function () {
            ...
            //save to cart
            function saveCart() {
                localStorage.setItem('cart-added-products', JSON.stringify(cart));
            ...
            const rebuildProductTable = function () {
                tBody.innerHTML = "";
                const store = localStorage.getItem("cart-added-products");
                if (!store) return;
            ...
            const emptyCart = function () {
                cart = [];
                localStorage.removeItem('cart-added-products');
            }
