<%@ Page Title="Sub-Admin Page Access" Language="C#" MasterPageFile="~/Basic.Master" AutoEventWireup="true" CodeBehind="Manage_Sub_Admin_Access.aspx.cs" Inherits="CncAgro.AccessAdmin.Sub_Admin.Manage_Sub_Admin_Access" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="card card-body">
        ...
        <div class="alert alert-info">Add more or remove access pages for sub-admin</div>
